...
**Запускает** программы Windows, которые вы сами добавили, внутри отдельного
окружения. Это окружение не песочница: программа внутри него видит ваш
...
| Адрес | Зачем |
|---|---|
| `github.com`, `api.github.com` | компоненты, нужные продукту для запуска программ Windows; проверка обновлений продукта |
...
- **Программа Windows добралась до файлов пользователя.** Так устроено такое
  окружение, это его заявленное поведение, и продукт об этом предупреждает.
